...
> ⚠️ **关于Netlify部署的重要说明**：本模板对Netlify采用最小化部署方式。仅将身份验证相关文件（管理界面和身份验证页面）部署到Netlify，而非整个博客。这是有意为之的，因为主要博客内容通过GitHub Pages提供，而Netlify仅提供身份验证服务。
