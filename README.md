...
⚠️ **重要提示：** 这一步非常关键！必须在Netlify Identity Widget脚本加载前预先配置API URL，否则身份验证将会失败。请确保将所有出现的`your-netlify-site-name.netlify.app`替换为你自己的Netlify站点域名（如"my-blog-123456.netlify.app"）。
