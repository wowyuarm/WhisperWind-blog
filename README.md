...
```javascript
// Netlify Identity URL前缀
window.netlifyIdentityURLPrefix = "https://your-netlify-site-name.netlify.app/.netlify/identity";
...
请务必将上述两个文件中的所有`your-netlify-site-name.netlify.app`替换为你自己的Netlify站点域名!
